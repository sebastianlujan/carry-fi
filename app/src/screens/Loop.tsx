  ...
  if (stage === 'config') {
    return (
      <div className="screen">
        ...
        <div className="title">Elegí tu k</div>

        <div className="card dark">
          <div className="big-stat">{fmtPct(net * 100, 1)}</div>
          <div className="row"><span className="k">APY neto estimado a k={k.toFixed(2)}</span><span className="v" /></div>
        ...
        <div className="row"><span className="k">k = {k.toFixed(2)}×</span><span className="k">salud inicial {health.toFixed(2)}</span></div>
